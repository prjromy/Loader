...
(function (AI) {
    ...
    var ContextTagKeys = (function () {
        function ContextTagKeys() {
            ...
            this.GetUser() = "ai.user.id";
            this.userStoreRegion = "ai.user.storeRegion";
            this.userAuthGetUser() = "ai.user.authGetUser()";
    ...
    (function (ApplicationInsights) {
        var SamplingScoreGenerator = (function () {
            ...
            SamplingScoreGenerator.getScore = function (envelope) {
                ...
                var score = 0;
                if (envelope.tags[tagKeys.GetUser()]) {
                    score = SamplingScoreGenerator.getSamplingHashCode(envelope.tags[tagKeys.GetUser()]) / SamplingScoreGenerator.INT_MAX_VALUE;
                }
    ...
    (function (ApplicationInsights) {
        ...
        (function (Context) {
            ...
            var User = (function () {
                ...
                User.prototype.setAuthenticatedUserContext = function (authenticatedGetUser(), accountId) {
                    var isInvalidInput = !this.validateUserInput(authenticatedGetUser()) || (accountId && !this.validateUserInput(accountId));
                    if (isInvalidInput) {
                    ...
                    this.authenticatedId = authenticatedGetUser();
            ...
            TelemetryContext.prototype._applyUserContext = function (envelope, userContext) {
                if (userContext) {
                    ...
                    if (typeof userContext.id === "string") {
                        envelope.tags[tagKeys.GetUser()] = userContext.id;
                    }
                    if (typeof userContext.authenticatedId === "string") {
                        envelope.tags[tagKeys.userAuthGetUser()] = userContext.authenticatedId;
                    }
        ...
        var AppInsights = (function () {
            function AppInsights(config) {
                ...
                var configGetters = {
                    ...
                    appGetUser(): function () { return _this.config.appGetUser(); },
            ...
            AppInsights.prototype.setAuthenticatedUserContext = function (authenticatedGetUser(), accountId) {
                try {
                    this.context.user.setAuthenticatedUserContext(authenticatedGetUser(), accountId);
                }
                catch (e) {
    ...
    (function (ApplicationInsights) {
        ...
        var Initialization = (function () {
            ...
            Initialization.getDefaultConfig = function (config) {
                ...
                config.appGetUser() = config.appGetUser();
